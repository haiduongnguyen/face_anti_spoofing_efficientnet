...
def show_diff_cv_tf(img_path='', mode_resize = 'linear', new_size=10):
...
def show_diff_cv_pil(img_path='', mode_resize = 'linear', new_size=10):
    if mode_resize == 'linear':
        cv_code = cv2.INTER_LINEAR
...
if __name__ == '__main__':
    ...
    # show_diff_cv_tf(img_path, mode_resize='nearest', new_size=10)
    show_diff_cv_pil(img_path, mode_resize='nearest', new_size=100)
